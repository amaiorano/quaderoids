...
import darkenTextureFragShaderCode from './shaders/darken_texture.frag.wgsl';
import { Pipeline } from './pipeline';

export class DarkenTexturePipeline extends Pipeline {
    ...
    private init() {
        this.pipeline = this.device.createRenderPipeline(
            // GPURenderPipelineDescription
            {
                ...
                fragment: {
                    module: this.device.createShaderModule({
                        code: darkenTextureFragShaderCode
                    }),
                    entryPoint: 'main',
                    targets: [
                        // GPUColorTargetState
    ...
    encodeCommands(sourceTextureView: GPUTextureView, targetTextureView: GPUTextureView, flipY: boolean, deltaTime: number, darkenRate: number): GPUCommandBuffer {
